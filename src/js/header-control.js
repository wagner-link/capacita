...
class HeaderController {
    ...
    checkLoggedInUser() {
        ...
        if (userData) {
            ...
            this.updateHeaderButton(user, true);
        } else {
            this.updateHeaderButton(null, false);
        }
    }

    updateHeaderButton(user, isLoggedIn) {
        ...
        if (isLoggedIn && user) {
            const userHtml = `
                <div class="user-info-header">
                    ...
                    <span class="user-type-header">${user.tipoUsuario === 'atirador' ? 'Aluno' : 'Empresa'}</span>
                </div>
            `;
    ...
    setupLoginButtons() {
        ...
        if (headerLoginBtn) {
            headerLoginBtn.addEventListener('click', (e) => {
                ...
                if (userData) {
                    e.preventDefault();
                    // Aqui você pode redirecionar para o dashboard do usuário se ele estiver logado
